...
public class CropFrame extends AppCompatImageView {
    ...
    private void updateCropSize() {
        left = (float) x1 / xMax;
        right = (float) x2 / xMax;
        top = (float) (yMax - y1) / yMax;
        bottom = (float) (yMax - y2) / yMax;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //draw crop frame
        paint.setColor(ContextCompat.getColor(context, R.color.crop_overlay_color));
        ...
        int strokeColorId = touchPoint == CENTER ? R.color.crop_highlight_color : R.color.crop_frame_stroke;
